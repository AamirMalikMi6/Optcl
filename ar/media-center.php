        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <a href="media-center.php" class="btn w-100 mc-nav active">اخبار عامة</a>
              <a href="media-center.php" class="btn w-100 mc-nav">معرض الصور</a>
                      ...
                      <div class="mc-caption mobile-text-end mobile-mc-caption-height-35 mobile-mc-caption-padding">
                        ...
                        <div class="bottom hideThis">
                          <div class="row">
                            <div class="col-1"></div>
                            <div class="col-10">
                               <center><a href="#" class="btn btn-warning btn-yellow w-100">أقرا المزيد</a></center>
                            </div>
                            <div class="col-1"></div>
                          </div>
                        </div>
