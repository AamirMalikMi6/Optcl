                    ...
                    <div class="row">
                      ...
                      <div class="col-md-7">
                        ...
                        <center>
                          ...
                          <h3 class="fnt-blue fnt-poppins-regular fnt-30">منذ عـــــــــــــــــــــــــــام </h3>
                        </center>
                ...
                <div class="row">
                  ...
                  <div class="col-md-7">
                    <div class="teardropbox">
                      <img id="bg-teardrop" src="../img/teardrop.svg" class="img-fluid flip-img w-100 pb-red">
            ...
            <div class="col-6 col-md-2">
                <div class="spacer-40"></div>
                  <center>  
                      ...
                      <p class="fd-type fnt-blue remMar">علامة تجارية</p>
                  </center>
               <div class="spacer-40"></div>
            </div>
            ...
            <div class="col-6 col-md-2">
               <div class="spacer-40"></div>
                  <center>  
                      ...
                      <p class="fd-type fnt-blue remMar">صنف</p>
                  </center>
            ...
            <div class="col-6 col-md-2">
               <div class="spacer-40"></div>
                  <center>  
                      ...
                      <p class="fd-type fnt-blue remMar">عميل</p>
                  </center>
            ...
            <div class="col-6 col-md-2">
               <div class="spacer-40"></div>
                  <center>  
                      ...
                      <p class="fd-type fnt-blue remMar">موظف</p>
                  </center>
              ...
              <div class="col-md-6">
                <a href="">
                  <center>
                    ...
                    <p class="fnt-blue fnt-25"><b>المنتجات الغذائية</b></p>
                  </center>
                </a>
              </div>
              ...
              <div class="col-md-6">
                <a href="">
                  <center>
                    ...
                    <div class="spacer-10"></div>
                    <p class="fnt-blue fnt-25"><b>المنتجات الغير غذائية</b></p>
                  </center>
                </a>
              </div>
              ...
              <div class="col-md-6">
                <a href="">
                  <center>
                    ...
                    <div class="spacer-10"></div>
                    <p class="fnt-blue fnt-25"><b>منتجات الحيوانات الأليفة</b></p>
                  </center>
                </a>
              </div>
              <div class="col-md-3"></div>
            ...
            <div class="services-gallery">
              ...
              <div class="service-items services-header" id="serv-2">
                ...
                <div class="bottom">
                  ...
                  <h4 class="fnt-blue">السوبر ماركت</h4>
                  <p class="fnt-blue fnt-20">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق.</p>
                  <div class="spacer-40"></div>
              ...
              <div class="service-items services-header" id="serv-3">
                ...
                <div class="bottom">
                  ...
                  <h4 class="fnt-blue">المطاعم و الفنادق</h4>
                  <p class="fnt-blue fnt-20">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق.</p>
                  <div class="spacer-40"></div>
              ...
              <div class="service-items services-header" id="serv-4">
                ...
                <div class="bottom">
                  ...
                  <h4 class="fnt-blue">الأسر المنتجة</h4>
                  <p class="fnt-blue fnt-20">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق.</p>
                  <div class="spacer-40"></div>
          ...
          <div class="row">
            ...
            <div class="item-thumb col">
              <center>
                ...
                <p class="caption fnt-white">تقديم الطعام</p>
              </center>
            </div>
            ...
            <div class="item-thumb col">
              <center>
                ...
                <p class="caption fnt-white">الموردون</p>
              </center>
            </div> 
            ...
            <div class="caption item-thumb col">
              <center>
                ...
                <p class="caption fnt-white">السوبر ماركت</p>
              </center>
            </div> 
            ...
            <div class="item-thumb col">
              <center>
                ...
                <p class="caption fnt-white">المطاعم و الفنادق</p>
              </center>
            </div>
            ...
            <div class="item-thumb col">
              <center>
                ...
                <p class="caption fnt-white">الأسر المنتجة</p>
              </center>
            </div>                                        
